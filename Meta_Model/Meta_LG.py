...
# ======================================================================================================================
# ----------------------------------------------------------------------------- Start
# META LOGISTIC REGRESSION SETUP
# ----------------------------------------------------------------------------- 
...
# ----------------------------------------------------------------------------- Start
# BASE META LOGISTIC REGRESSION
# ----------------------------------------------------------------------------- 
def base_meta_logistic_optuna(trial):
...
print("\n========== BASE META LOGISTIC REGRESSION MODEL ==========")
base_meta_logistic_study = optuna.create_study(
    direction="maximize",
    sampler=optuna.samplers.TPESampler(seed=42)
    )
base_meta_logistic_study.optimize(
    base_meta_logistic_optuna,
    n_trials=30
)
base_meta_logistic_best = base_meta_logistic_study.best_params

base_meta_logistic_model = Pipeline([
    ("scaler", StandardScaler()),
    ("lr", LogisticRegression(
        C=base_meta_logistic_best['C'],
        solver="lbfgs",
        l1_ratio=0,
        max_iter=30000
    ))
...
# ----------------------------------------------------------------------------- Start
# MIXED META LOGISTIC REGRESSION
# ----------------------------------------------------------------------------- 
def mixed_meta_logistic_optuna(trial):
    optuna_meta_logistic_model = Pipeline([
        ("scaler", StandardScaler()),
        ("lr", LogisticRegression(
            C=trial.suggest_float("C", 0.001, 10.0, log=True),
...
print("\n========== MIXED META LOGISTIC REGRESSION MODEL ==========")
mixed_meta_logistic_study = optuna.create_study(
    direction="maximize",
    sampler=optuna.samplers.TPESampler(seed=42)
    )
mixed_meta_logistic_study.optimize(
    mixed_meta_logistic_optuna,
    n_trials=30
)
mixed_meta_logistic_best = mixed_meta_logistic_study.best_params

mixed_meta_logistic_model = Pipeline([
    ("scaler", StandardScaler()),
    ("lr", LogisticRegression(
        C=mixed_meta_logistic_best['C'],
        solver="lbfgs",
        l1_ratio=0,
        max_iter=30000
    ))
])
mixed_meta_logistic_model.fit(mixed_meta_features_train, sentiment_train)
mixed_meta_logistic_test_sentiment = mixed_meta_logistic_model.predict(mixed_meta_features_test)
# ----------------------------------------------------------------------------- END

# ----------------------------------------------------------------------------- Start
# ENHANCED LOGISTIC REGRESSION
# ----------------------------------------------------------------------------- 
def enhanced_meta_logistic_optuna(trial):
    optuna_meta_logistic_model = Pipeline([
        ("scaler", StandardScaler()),
        ("lr", LogisticRegression(
            C=trial.suggest_float("C", 0.001, 10.0, log=True),
...
print("\n========== ENHANCED META LOGISTIC REGRESSION MODEL ==========")
enhanced_meta_logistic_study = optuna.create_study(
    direction="maximize", 
    sampler=optuna.samplers.TPESampler(seed=42)
    )
enhanced_meta_logistic_study.optimize(
    enhanced_meta_logistic_optuna,
    n_trials=30
)
enhanced_meta_logistic_best = enhanced_meta_logistic_study.best_params

enhanced_meta_logistic_model = Pipeline([
    ("scaler", StandardScaler()),
    ("lr", LogisticRegression(
        C=enhanced_meta_logistic_best['C'],
        solver="lbfgs",
        l1_ratio=0,
        max_iter=30000
    ))
])
enhanced_meta_logistic_model.fit(enhanced_meta_features_train, sentiment_train)
enhanced_meta_logistic_test_sentiment = enhanced_meta_logistic_model.predict(enhanced_meta_features_test)
# ----------------------------------------------------------------------------- END

# ----------------------------------------------------------------------------- Start
# READABLE XAI FUNCTIONS
# -----------------------------------------------------------------------------
...
def save_readable_local_xai_report(
    ...
    predicted_probabilities = model.predict_proba(feature_values)
    ...
    for row_index in row_indices:
        ...
        prediction_confidence = predicted_probabilities[row_index][predicted_class_index]

        class_coefficients = lr_model.coef_[predicted_class_index]
...
# ----------------------------------------------------------------------------- Start
# EVALUATE META LOGISTIC REGRESSION
# ----------------------------------------------------------------------------- 
print("\nBASE META LOGISTIC REGRESSION BEST PARAMETERS: " + str(base_meta_logistic_study.best_value))
print(base_meta_logistic_best)
print("BASE META LOGISTIC REGRESSION MODEL ON TEST: ACCURACY = " + str(round(accuracy_score(sentiment_test, base_meta_logistic_test_sentiment) * 100, 4)) + "%")
...
print("\nMIXED META LOGISTIC REGRESSION BEST PARAMETERS: " + str(mixed_meta_logistic_study.best_value))
print(mixed_meta_logistic_best)
print("MIXED META LOGISTIC REGRESSION MODEL ON TEST: ACCURACY = " + str(round(accuracy_score(sentiment_test, mixed_meta_logistic_test_sentiment) * 100, 4)) + "%")
print(classification_report(sentiment_test, mixed_meta_logistic_test_sentiment, digits=4))
...
print("\nENHANCED META LOGISTIC REGRESSION BEST PARAMETERS: " + str(enhanced_meta_logistic_study.best_value))
print(enhanced_meta_logistic_best)
print("ENHANCED META LOGISTIC REGRESSION MODEL ON TEST: ACCURACY = " + str(round(accuracy_score(sentiment_test, enhanced_meta_logistic_test_sentiment) * 100, 4)) + "%")
print(classification_report(sentiment_test, enhanced_meta_logistic_test_sentiment, digits=4))
...
print("\n========== BASE META LOGISTIC CORRECT XAI EXAMPLES ==========")
...
print("\n========== BASE META LOGISTIC WRONG XAI EXAMPLES ==========")
print(base_readable_xai_report_df[
...
print("\n========== MIXED META LOGISTIC CORRECT XAI EXAMPLES ==========")
...
print("\n========== MIXED META LOGISTIC WRONG XAI EXAMPLES ==========")
print(mixed_readable_xai_report_df[
...
enhanced_readable_xai_report_df = save_readable_local_xai_report(
...
print("\n========== ENHANCED META LOGISTIC CORRECT XAI EXAMPLES ==========")
...
print("\n========== ENHANCED META LOGISTIC WRONG XAI EXAMPLES ==========")
print(enhanced_readable_xai_report_df[
...
base_meta_logistic_test_report_df = pd.DataFrame(
...
mixed_meta_logistic_test_report_df = pd.DataFrame(
    classification_report(
        sentiment_test,
...
enhanced_meta_logistic_test_report_df = pd.DataFrame(
    classification_report(
        sentiment_test,
...
mixed_meta_logistic_test_report_df.to_csv(
    os.path.join(output_folder, "mixed_meta_logistic_test_classification_report.csv"),
    index_label="class"
)

enhanced_meta_logistic_test_report_df.to_csv(
    os.path.join(output_folder, "enhanced_meta_logistic_test_classification_report.csv"),
    index_label="class"
)
...
table = ax.table(
    cellText=base_meta_logistic_test_report_df.values,
    rowLabels=base_meta_logistic_test_report_df.index,
    colLabels=base_meta_logistic_test_report_df.columns,
    loc="center"
)
...
plt.savefig(
    os.path.join(output_folder, "base_meta_logistic_test_classification_report.png"),
    bbox_inches="tight",
    dpi=300
)
plt.close()
...
table = ax.table(
    cellText=mixed_meta_logistic_test_report_df.values,
    rowLabels=mixed_meta_logistic_test_report_df.index,
    colLabels=mixed_meta_logistic_test_report_df.columns,
    loc="center"
)
...
plt.savefig(
    os.path.join(output_folder, "mixed_meta_logistic_test_classification_report.png"),
    bbox_inches="tight",
    dpi=300
)
plt.close()
...
table = ax.table(
    cellText=enhanced_meta_logistic_test_report_df.values,
    rowLabels=enhanced_meta_logistic_test_report_df.index,
    colLabels=enhanced_meta_logistic_test_report_df.columns,
    loc="center"
)
...
plt.savefig(
    os.path.join(output_folder, "enhanced_meta_logistic_test_classification_report.png"),
    bbox_inches="tight",
    dpi=300
)
plt.close()
