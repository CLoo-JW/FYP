...
def save_readable_local_svm_xai_report(
    ...
    for row_index in row_indices:
        ...
        prediction_confidence = decision_confidences[row_index][predicted_class_index]
...
# SAVE OUTPUT / XAI
# ----------------------------------------------------------------------------- 
xai_output_folder = "Meta_Model/XAI/SVM"
...
print("\nSaved SVM XAI Report to:", xai_output_folder)
